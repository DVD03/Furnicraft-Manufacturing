    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {!isOpen && (
        <button
          ...
          className="relative group p-4 rounded-full bg-gradient-to-r from-amber-500 via-amber-600 to-orange-600 text-black shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 flex items-center space-x-2 border border-amber-300/40"
        >
